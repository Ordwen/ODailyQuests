...
public class ProgressBar {
    ...
    public void load() {
        ...
        symbol = section.contains("symbol") ? section.getString("symbol") : "|";
        completedColor = section.contains("completed_color") ? ColorConvert.convertColorCode(section.getString("completed_color")) : ChatColor.GREEN.toString();
        remainingColor = section.contains("remaining_color") ? ColorConvert.convertColorCode(section.getString("remaining_color")) : ChatColor.GRAY.toString();
        amountOfSymbols = section.contains("amount_of_symbols") ? section.getInt("amount_of_symbols") : 20;
    }
